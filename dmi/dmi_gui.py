...
progress_bar = ttk.Progressbar(progress_bar_frame, length=200)
...
df.load_into_func(progress_bar_label, progress_info_text, progress_bar, map_label, request_button)
